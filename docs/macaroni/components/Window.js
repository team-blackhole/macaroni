(() => {
  ...
  var n = (n6) => (e5) => typeof e5 == "function" ? ((n7, e6) => (window.customElements.define(n7, e6), e6))(n6, e5) : ((n7, e6) => {
  ...
  var i = (i4, e5) => e5.kind === "method" && e5.descriptor && !("value" in e5.descriptor) ? { ...e5, finisher(n6) {
  ...
  var s = class {
    ...
    get styleSheet() {
      ...
      return t && e5 === void 0 && (n2.set(this.cssText, e5 = new CSSStyleSheet()), e5.replaceSync(this.cssText)), e5;
    }
    toString() {
      return this.cssText;
    }
  };
  var o2 = (t3) => new s(typeof t3 == "string" ? t3 : t3 + "", e2);
  var r = (t3, ...n6) => {
  ...
  var r2 = e3 ? e3.emptyScript : "";
  var h = window.reactiveElementPolyfillSupport;
  var o3 = { toAttribute(t3, i4) {
    switch (i4) {
      case Boolean:
        t3 = t3 ? r2 : null;
        break;
  ...
  var n3 = (t3, i4) => i4 !== t3 && (i4 == i4 || t3 == t3);
  ...
  var a = class extends HTMLElement {
    ...
    _$ES(t3, i4, s5 = l) {
      ...
      if (h4 !== void 0 && s5.reflect === true) {
        const n6 = ((r5 = (e5 = s5.converter) === null || e5 === void 0 ? void 0 : e5.toAttribute) !== null && r5 !== void 0 ? r5 : o3.toAttribute)(i4, s5.type);
    ...
    _$AK(t3, i4) {
      ...
      if (n6 !== void 0 && this._$Ei !== n6) {
        const t4 = h4.getPropertyOptions(n6), l4 = t4.converter, a3 = (r5 = (e5 = (s5 = l4) === null || s5 === void 0 ? void 0 : s5.fromAttribute) !== null && e5 !== void 0 ? e5 : typeof l4 == "function" ? l4 : null) !== null && r5 !== void 0 ? r5 : o3.fromAttribute;
        this._$Ei = n6, this[n6] = a3(i4, t4.type), this._$Ei = null;
      }
    }
    requestUpdate(t3, i4, s5) {
      let e5 = true;
      t3 !== void 0 && (((s5 = s5 || this.constructor.getPropertyOptions(t3)).hasChanged || n3)(this[t3], i4) ? (this._$AL.has(t3) || this._$AL.set(t3, i4), s5.reflect === true && this._$Ei !== t3 && (this._$E_ === void 0 && (this._$E_ = new Map()), this._$E_.set(t3, s5))) : e5 = false), !this.isUpdatePending && e5 && (this._$Ep = this._$EC());
    }
    async _$EC() {
  ...
  var s3 = i3 ? i3.createPolicy("lit-html", { createHTML: (t3) => t3 }) : void 0;
  ...
  var C = (t3, i4) => {
    ...
    for (let i5 = 0; i5 < o6; i5++) {
      ...
      r5 += d2 === c ? s5 + n4 : $2 >= 0 ? (l4.push(o7), s5.slice(0, $2) + "$lit$" + s5.slice($2) + e4 + y2) : s5 + e4 + ($2 === -2 ? (l4.push(void 0), i5) : y2);
    }
      ...
      for (; (l4 = A.nextNode()) !== null && c2.length < u2; ) {
        if (l4.nodeType === 1) {
            ...
            for (const i4 of l4.getAttributeNames())
              if (i4.endsWith("$lit$") || i4.startsWith(e4)) {
                ...
                if (t4.push(i4), s6 !== void 0) {
                  const t5 = l4.getAttribute(s6.toLowerCase() + "$lit$").split(e4), i5 = /([.?@])?(.*)/.exec(s6);
          ...
          if (g.test(l4.tagName)) {
            const t4 = l4.textContent.split(e4), s6 = t4.length - 1;
            if (s6 > 0) {
          ...
          if (l4.data === o4)
            ...
            let t4 = -1;
            for (; (t4 = l4.data.indexOf(e4, t4 + 1)) !== -1; )
              c2.push({ type: 7, index: r5 }), t4 += e4.length - 1;
          }
        r5++;
      }
    }
  ...
  __decorateClass([
    e({ type: Boolean })
  ], Window.prototype, "title", 2);
  Window = __decorateClass([
    n("macaroni-window")
  ], Window);
})();
/**
